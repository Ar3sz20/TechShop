            ...
            <aside class="filters-sidebar">
                ...
                <form method="GET" action="{{ route('products.index') }}">
                    ...
                    <select name="category">
                        ...
                        <option value="Smartproduct" {{ request('category') == 'Smartproduct' ? 'selected' : '' }}>Okos
                            eszközök</option>
                        <option value="Household" {{ request('category') == 'Household' ? 'selected' : '' }}>Háztartási
                        </option>
                        ...
                        <option value="Accessories" {{ request('category') == 'Accessories' ? 'selected' : '' }}>Kiegészítők
                        </option>
                        <option value="Components" {{ request('category') == 'Components' ? 'selected' : '' }}>Alkatrészek
                        </option>
                    </select>
                    <label>Típus:</label>
                    ...
                    @elseif (request('category') == 'Gaming')
                        <select name="type">
                            ...
                            <option value="HandholdConsole" {{ request('type') == 'HandholdConsole' ? 'selected' : '' }}>Kézi
                                konzolok</option>
                            <option value="VR" {{ request('type') == 'VR' ? 'selected' : '' }}>VR eszközök</option>
                            <option value="Controller" {{ request('type') == 'Controller' ? 'selected' : '' }}>Kontrollerek
                            </option>
                        </select>
                    ...
                    @elseif (request('category') == 'Household')
                        <select name="type">
                            ...
                            <option value="WashingMachine" {{ request('type') == 'WashingMachine' ? 'selected' : '' }}>Mosógépek
                            </option>
                            <option value="Refrigerator" {{ request('type') == 'Refrigerator' ? 'selected' : '' }}>Hűtőszekrények
                            </option>
                            <option value="Oven" {{ request('type') == 'Oven' ? 'selected' : '' }}>Sütők</option>
                            <option value="VacuumCleaner" {{ request('type') == 'VacuumCleaner' ? 'selected' : '' }}>Porszívók
                            </option>
                        </select>
